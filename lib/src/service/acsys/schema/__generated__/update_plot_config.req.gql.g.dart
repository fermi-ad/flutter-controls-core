...
part of 'update_plot_config.req.gql.dart';
...
class _$GUpdatePlotConfigReq extends GUpdatePlotConfigReq {
  @override
  final _i3.GUpdatePlotConfigVars vars;
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is GUpdatePlotConfigReq &&
        vars == other.vars &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GUpdatePlotConfigReq')
          ..add('vars', vars)
...
class GUpdatePlotConfigReqBuilder
    implements Builder<GUpdatePlotConfigReq, GUpdatePlotConfigReqBuilder> {
  _$GUpdatePlotConfigReq? _$v;
  ...
  GUpdatePlotConfigReqBuilder() {
    GUpdatePlotConfigReq._initializeBuilder(this);
  }

  GUpdatePlotConfigReqBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void update(void Function(GUpdatePlotConfigReqBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GUpdatePlotConfigReq build() => _build();
